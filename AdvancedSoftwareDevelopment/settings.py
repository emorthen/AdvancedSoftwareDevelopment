"""
Django settings for AdvancedSoftwareDevelopment project.
...
file = open(BASE_DIR+"/secret_key_file", 'r')
...
ROOT_URLCONF = 'AdvancedSoftwareDevelopment.urls'
...
WSGI_APPLICATION = 'AdvancedSoftwareDevelopment.wsgi.application'
